...
if __name__ == '__main__':
    ...
    print("IPs:")
    print(f"\t172.31.63.67: {ip_dict.get('172.31.63.67')}")
    print(f"\t172.31.2.14: {ip_dict.get('172.31.2.14')}")
    print(f"\t172.31.29.194: {ip_dict.get('172.31.29.194')}")
    print(f"\t69.162.124.230: {ip_dict.get('69.162.124.230')}")
    print(f"\t64.124.26.109: {ip_dict.get('64.124.26.109')}")
    print(f"\t64.62.224.29: {ip_dict.get('64.62.224.29')}")
    print(f"\t34.207.121.61: {ip_dict.get('34.207.121.61')}")
    print(f"\t47.88.100.4: {ip_dict.get('47.88.100.4')}")
    print(f"\t45.249.84.250: {ip_dict.get('45.249.84.250')}")
    print(f"\t216.244.66.228: {ip_dict.get('216.244.66.228')}")
